...
const TimelineItem = (items: any) => {
    ...
    return items.map((item: any, index: number) => <Timeline.Item data-aos="fade-up" data-aos-duration="800"
        ...
        <div className="border shadow-[0_0_10px_0_#3B82F650] hover:-translate-y-2 transition transform duration-300 ease-in-out flex flex-col gap-2 border-primaryColor p-4 rounded-2xl sm-mx:p-2">
          ...
          <div className="text-slate-300 leading-6 text-justify md-mx:text-sm xs-mx:text-xs">
    {item.desc}
</div>


            <div className="text-lg font-medium text-slate-300 md-mx:text-base sm-mx:text-sm xs-mx:text-xs flex gap-1"><div className="font-semibold text-white">Skills:</div>
...
const Experience = () => {
    ...
    return <div className="px-16 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Experience">
        ...
        <Timeline color="#3B82F6" active={5} bulletSize={dot} lineWidth={2}>
            {
